...
use MediaLibrary\Domain\Model\Media\VideoPeer;
use MediaLibrary\Domain\Model\Media\map\VideoTableMap;
...
abstract class BaseVideoPeer
{
    ...
    const OM_CLASS = 'MediaLibrary\\Domain\\Model\\Media\\Video';

    /** the related TableMap class for this table */
    const TM_CLASS = 'MediaLibrary\\Domain\\Model\\Media\\map\\VideoTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseVideoPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \MediaLibrary\Domain\Model\Media\map\VideoTableMap());
      }
    }
