...
use MediaLibrary\Domain\Model\Media\GamePeer;
...
abstract class BaseGameQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'MediaLibrary\\Domain\\Model\\Media\\Game';
        }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \MediaLibrary\Domain\Model\Media\PlatformQuery A secondary query class using the current class as primary query
     */
    public function usePlatformQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPlatform($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Platform', '\MediaLibrary\Domain\Model\Media\PlatformQuery');
    }
