...
use MediaLibrary\Domain\Model\Media\map\GameTableMap;
...
abstract class BaseGamePeer
{
    ...
    const OM_CLASS = 'MediaLibrary\\Domain\\Model\\Media\\Game';

    /** the related TableMap class for this table */
    const TM_CLASS = 'MediaLibrary\\Domain\\Model\\Media\\map\\GameTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseGamePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \MediaLibrary\Domain\Model\Media\map\GameTableMap());
      }
    }
