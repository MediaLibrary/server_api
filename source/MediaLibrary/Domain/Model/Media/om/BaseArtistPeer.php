...
use MediaLibrary\Domain\Model\Media\map\ArtistTableMap;
...
abstract class BaseArtistPeer
{
    ...
    const OM_CLASS = 'MediaLibrary\\Domain\\Model\\Media\\Artist';

    /** the related TableMap class for this table */
    const TM_CLASS = 'MediaLibrary\\Domain\\Model\\Media\\map\\ArtistTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseArtistPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \MediaLibrary\Domain\Model\Media\map\ArtistTableMap());
      }
    }
