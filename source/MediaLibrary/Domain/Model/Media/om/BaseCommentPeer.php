...
use MediaLibrary\Domain\Model\Media\map\CommentTableMap;
...
abstract class BaseCommentPeer
{
    ...
    const OM_CLASS = 'MediaLibrary\\Domain\\Model\\Media\\Comment';

    /** the related TableMap class for this table */
    const TM_CLASS = 'MediaLibrary\\Domain\\Model\\Media\\map\\CommentTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCommentPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \MediaLibrary\Domain\Model\Media\map\CommentTableMap());
      }
    }
