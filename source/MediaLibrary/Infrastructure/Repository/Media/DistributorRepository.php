...
class DistributorRepository
{
    ...
    /**
     * @param DistributorQuery $query
     */
    public function __construct(DistributorQuery $query)
    {
        $this->query = $query;
    }
    ...
    /**
     * @return array|mixed|PropelObjectCollection|Distributor[]
     */
    ...
    /**
     * @param Distributor|Distributor[] $entityOrCollection
     * @throws Exception
     * @throws PropelException
     */
    public function save($entityOrCollection)
    {
        if ($entityOrCollection instanceof Distributor) {
