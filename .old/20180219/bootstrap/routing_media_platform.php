...
$application->delete('/media/platform/{id}', function (Application $application, $id) use ($locator) {
    $repository = $locator->getMediaPlatformRepository();
...
$application->get('/media/platform', function (Application $application, Request $request) use ($locator) {
...
$application->post('/media/platform', function (Application $application, Request $request) use ($locator) {
...
$application->put('/media/platform/{id}', function (Application $application, Request $request, $id) use ($locator) {
    $name       = $request->get('name');
    $repository = $locator->getMediaPlatformRepository();
