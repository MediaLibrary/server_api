...
use MediaLibrary\Domain\Model\Media\MediaToArtistPeer;
...
abstract class BaseMediaToArtistQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'MediaLibrary\\Domain\\Model\\Media\\MediaToArtist';
        }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \MediaLibrary\Domain\Model\Media\ArtistQuery A secondary query class using the current class as primary query
     */
    public function useArtistQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinArtist($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Artist', '\MediaLibrary\Domain\Model\Media\ArtistQuery');
    }
