...
use MediaLibrary\Domain\Model\Media\map\EditionTableMap;
...
abstract class BaseEditionPeer
{
    ...
    const OM_CLASS = 'MediaLibrary\\Domain\\Model\\Media\\Edition';

    /** the related TableMap class for this table */
    const TM_CLASS = 'MediaLibrary\\Domain\\Model\\Media\\map\\EditionTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseEditionPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \MediaLibrary\Domain\Model\Media\map\EditionTableMap());
      }
    }
