...
use MediaLibrary\Domain\Model\Media\MediaPeer;
...
abstract class BaseMediaQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'MediaLibrary\\Domain\\Model\\Media\\Media';
        }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \MediaLibrary\Domain\Model\Media\DistributorQuery A secondary query class using the current class as primary query
     */
    public function useDistributorQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'Distributor', '\MediaLibrary\Domain\Model\Media\DistributorQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \MediaLibrary\Domain\Model\Media\EditionQuery A secondary query class using the current class as primary query
     */
    public function useEditionQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinEdition($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Edition', '\MediaLibrary\Domain\Model\Media\EditionQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \MediaLibrary\Domain\Model\Media\TypeQuery A secondary query class using the current class as primary query
     */
    public function useTypeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinType($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Type', '\MediaLibrary\Domain\Model\Media\TypeQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \MediaLibrary\Domain\Model\User\UserQuery A secondary query class using the current class as primary query
     */
    public function useUserQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinUser($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'User', '\MediaLibrary\Domain\Model\User\UserQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \MediaLibrary\Domain\Model\Media\AudioQuery A secondary query class using the current class as primary query
     */
    public function useAudioQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinAudio($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Audio', '\MediaLibrary\Domain\Model\Media\AudioQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \MediaLibrary\Domain\Model\Media\BookQuery A secondary query class using the current class as primary query
     */
    public function useBookQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinBook($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Book', '\MediaLibrary\Domain\Model\Media\BookQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \MediaLibrary\Domain\Model\Media\VideoQuery A secondary query class using the current class as primary query
     */
    public function useVideoQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinVideo($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Video', '\MediaLibrary\Domain\Model\Media\VideoQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \MediaLibrary\Domain\Model\Media\CommentQuery A secondary query class using the current class as primary query
     */
    public function useCommentQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinComment($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Comment', '\MediaLibrary\Domain\Model\Media\CommentQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \MediaLibrary\Domain\Model\Media\MediaToArtistQuery A secondary query class using the current class as primary query
     */
    public function useMediaToArtistQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'MediaToArtist', '\MediaLibrary\Domain\Model\Media\MediaToArtistQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \MediaLibrary\Domain\Model\Media\MediaToGenreQuery A secondary query class using the current class as primary query
     */
    public function useMediaToGenreQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'MediaToGenre', '\MediaLibrary\Domain\Model\Media\MediaToGenreQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \MediaLibrary\Domain\Model\Media\MediaToLanguageQuery A secondary query class using the current class as primary query
     */
    public function useMediaToLanguageQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'MediaToLanguage', '\MediaLibrary\Domain\Model\Media\MediaToLanguageQuery');
    }
