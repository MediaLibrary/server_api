...
use MediaLibrary\Domain\Model\Media\BookPeer;
use MediaLibrary\Domain\Model\Media\MediaPeer;
use MediaLibrary\Domain\Model\Media\map\BookTableMap;
...
abstract class BaseBookPeer
{
    ...
    const OM_CLASS = 'MediaLibrary\\Domain\\Model\\Media\\Book';

    /** the related TableMap class for this table */
    const TM_CLASS = 'MediaLibrary\\Domain\\Model\\Media\\map\\BookTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseBookPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \MediaLibrary\Domain\Model\Media\map\BookTableMap());
      }
    }
