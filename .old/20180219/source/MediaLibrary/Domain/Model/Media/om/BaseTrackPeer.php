...
namespace MediaLibrary\Domain\Model\Media\Audio\om;
...
use MediaLibrary\Domain\Model\Media\Audio\TrackPeer;
use MediaLibrary\Domain\Model\Media\Audio\map\TrackTableMap;
...
abstract class BaseTrackPeer
{
    ...
    const OM_CLASS = 'MediaLibrary\\Domain\\Model\\Media\\Audio\\Track';

    /** the related TableMap class for this table */
    const TM_CLASS = 'MediaLibrary\\Domain\\Model\\Media\\Audio\\map\\TrackTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseTrackPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \MediaLibrary\Domain\Model\Media\Audio\map\TrackTableMap());
      }
    }
