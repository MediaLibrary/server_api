...
use MediaLibrary\Domain\Model\Media\MediaToLanguagePeer;
...
abstract class BaseMediaToLanguageQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'MediaLibrary\\Domain\\Model\\Media\\MediaToLanguage';
        }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \MediaLibrary\Domain\Model\Media\LanguageQuery A secondary query class using the current class as primary query
     */
    public function useLanguageQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinLanguage($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Language', '\MediaLibrary\Domain\Model\Media\LanguageQuery');
    }
