...
use MediaLibrary\Domain\Model\Media\map\LanguageTableMap;
...
abstract class BaseLanguagePeer
{
    ...
    const OM_CLASS = 'MediaLibrary\\Domain\\Model\\Media\\Language';

    /** the related TableMap class for this table */
    const TM_CLASS = 'MediaLibrary\\Domain\\Model\\Media\\map\\LanguageTableMap';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (LanguagePeer::ID, LanguagePeer::NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (LanguagePeer::ID => 0, LanguagePeer::NAME => 1, ),
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseLanguagePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \MediaLibrary\Domain\Model\Media\map\LanguageTableMap());
      }
    }
