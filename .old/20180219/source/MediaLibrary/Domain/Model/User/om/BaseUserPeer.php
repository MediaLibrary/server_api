...
use MediaLibrary\Domain\Model\User\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'MediaLibrary\\Domain\\Model\\User\\User';

    /** the related TableMap class for this table */
    const TM_CLASS = 'MediaLibrary\\Domain\\Model\\User\\map\\UserTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUserPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \MediaLibrary\Domain\Model\User\map\UserTableMap());
      }
    }
